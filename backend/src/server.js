...
<html lang="en">
  ...
  <body class="min-h-screen text-green-400">
    ...
    >
      ...
      <section
        class="matrix-panel w-full max-w-2xl rounded-xl p-8 font-mono"
      >

        <div
          class="mb-6 text-xs uppercase tracking-[0.35em] text-green-700"
        >
          System connection established
        </div>

        <h1
          class="matrix-text text-3xl font-bold tracking-tight text-green-400 md:text-4xl"
        >
          Hello Client, I am your Server!
        </h1>

        <p
          class="mt-4 leading-relaxed text-green-600"
        >
          Express + MongoDB + Supabase are ready.
        </p>
        ...
        <div class="mt-6 text-xs text-green-800">
          MongoDB: /api/v2/users
          <br />
          Supabase: /api/v2/users/pg
        </div>

        <footer
          class="mt-10 border-t border-green-950 pt-5 text-xs text-green-800"
        >
